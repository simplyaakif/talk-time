...
class GuideTalkTimeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.guideTalkTimes.index', compact('guideTalkTimes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.guideTalkTimes.create', compact('guides'));
    }
    ...
    public function store(StoreGuideTalkTimeRequest $request)
    {
        ...
        return redirect()->route('admin.guide-talk-times.index');
    }
    ...
    public function edit(GuideTalkTime $guideTalkTime)
    {
        ...
        return view('admin.guideTalkTimes.edit', compact('guides', 'guideTalkTime'));
    }
    ...
    public function show(GuideTalkTime $guideTalkTime)
    {
        ...
        return view('admin.guideTalkTimes.show', compact('guideTalkTime'));
    }
