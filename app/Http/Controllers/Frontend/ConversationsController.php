...
class ConversationsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.conversations.create', compact('talent', 'guides'));
    }
    ...
    public function store(StoreConversationRequest $request)
    {
        ...
        return redirect()->route('frontend.conversations.index');
    }
    ...
    public function edit(Conversation $conversation)
    {
        ...
        return view('frontend.conversations.edit', compact('talent', 'guides', 'conversation'));
    }
