                        ...
                        <tr data-entry-id="{{ $conversation->id }}">
                            ...
                            <td>
                                @can('conversation_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.conversations.show', $conversation->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('conversation_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.conversations.edit', $conversation->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('conversation_delete')
                                    <form action="{{ route('admin.conversations.destroy', $conversation->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
