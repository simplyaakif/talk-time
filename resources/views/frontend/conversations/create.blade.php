    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.conversations.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="guide_remarks" id="guide_remarks">{{ old('guide_remarks') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="talent_remarks" id="talent_remarks">{{ old('talent_remarks') }}</textarea>
