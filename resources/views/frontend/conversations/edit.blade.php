    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.conversations.update", [$conversation->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="guide_id" id="guide_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="start_time" id="start_time" value="{{ old('start_time', $conversation->start_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="end_time" id="end_time" value="{{ old('end_time', $conversation->end_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="guide_remarks" id="guide_remarks">{{ old('guide_remarks', $conversation->guide_remarks) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="talent_remarks" id="talent_remarks">{{ old('talent_remarks', $conversation->talent_remarks) }}</textarea>
